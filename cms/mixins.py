...
class CmsBaseMixin(AutoPermissionRequiredMixin, AllowedActionsMixin, PageTitleMixin):
    pass


class CmsBaseEditMixin(CmsBaseMixin, SuccessMessageMixin, InlineFormsetMixin):
